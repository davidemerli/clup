...
\input{Files/2 - architectural_design}

%------------------------------------------------------------------------------------------------------------------------------------------------
\clearpage
\section{User Interface}
\label{sect:user_interface}
\input{Files/3 - user_interface}

%------------------------------------------------------------------------------------------------------------------------------------------------
\clearpage
\section{Requirement Traceability}
\label{sect:requirement_traceability}
\input{Files/4 - requirement Traceability}

%------------------------------------------------------------------------------------------------------------------------------------------------
\clearpage
\section{Implementation, Integration and Test Plan}
\label{sect:iit}
\input{Files/5 - implementation_integration_testplan}
